...
"https://valuebargainsonline.com/wp-content/uploads/2019/09/SEMIR-jeans-for-men-slim-fit-pants-classic-2019-jeans-male-denim-jeans-Designer-Trousers-Casual.jpg" , 
...
export class ListProducts extends React.Component {
    ...
    getProduct(index){
        ...
        return <Product image={images[randImage]} price={randPrice} title={elements[index].title} description={elements[index].description} />
    }
}